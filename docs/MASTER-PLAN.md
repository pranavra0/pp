...
> `pragmatic-suffix-conventions` @ `852ee03`, 2026-07-14 (A1–A5 committed),
> plus the A6/A7/A′1 work living in the working tree (uncommitted): new module
> `src/surface_tables.ml`, reader/lint rewiring, SPEC amendments, and
> `tests/064`–`066`. Any edit to a status entry must update this pin. A status
> table that doesn't name its ref is a defect (this bit a reviewer once
> already).
